...
# Request CPU resource for MPI+OpenMP job, suppose it is a 2 MPI processes, each process has 4 OpenMP-threads
# SBATCH --ntasks=2
...
# 
# Set OMP_NUM_THREADS to the same value as: --cpus-per-task=4
