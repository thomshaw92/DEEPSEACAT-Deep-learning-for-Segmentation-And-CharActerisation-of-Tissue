...
config["labels"] = (1, 2, 3, 4, 5, 6)       # the label numbers on the input image, should the 0 label be included??
...
config['data_path'] = '/afm01/Q1/Q1219/data/data_for_network_new_config_111/'
config["data_file"] = os.path.abspath('/afm01/Q1/Q1219/data/train_val.hdf5')      # Typically hdf5 file
config["model_file"] = os.path.abspath("model_test.h5")    # If you have a model it will load model, if not it will save as this name
