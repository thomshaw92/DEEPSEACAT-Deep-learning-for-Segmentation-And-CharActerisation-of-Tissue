...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 15:22:29 2019
...
def run_validation_case(data_index, output_dir, model, data_file, training_modalities,
    ...
    NOTE that this function depends on the pickled validation index files, which is NOT the same as the original subjects!
    so when this outputs validation_case_15 it is NOT == 015 in the input set.
    Instead it is index 15 in the loaded training file list (which in the current case is subject 021)
