...
### BOXPLOT ###
tot_vol_true = [l1,l2,l3,l4,l5,l6,l8]
tot_true = np.reshape(tot_vol_true,[7,11])
tot_true = tot_true.transpose()

tot_vol_pred = [p1,p2,p3,p4,p5,p6,p8]
tot_pred = np.reshape(tot_vol_pred,[7,11])
tot_pred = tot_pred.transpose()

dice_label_array = tot_pred*0.35**3
dice_label1_array = tot_true*0.35**3


box_plot_data=[dice_label_array[:,0], dice_label_array[:,1], dice_label_array[:,2], dice_label_array[:,3], dice_label_array[:,4], dice_label_array[:,5], dice_label_array[:,6], np.mean(dice_label_array,axis=0)]
box_plot_data1=[dice_label1_array[:,0], dice_label1_array[:,1], dice_label1_array[:,2], dice_label1_array[:,3], dice_label1_array[:,4], dice_label1_array[:,5], dice_label1_array[:,6], np.mean(dice_label1_array,axis=0)]
